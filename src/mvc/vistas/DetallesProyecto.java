...
public class DetallesProyecto extends JDialog {
	...
	public void añadirIntegrante(UsuarioVO integrante) {
		...
		modelIntegrantes.addRow(new Object[]{integrante.getUser_id()+"", integrante.getNombre(), integrante.getExpediente()});
	...
	public boolean validarCampos() {
		...
		// Comprobar que todos los campos requeridos están rellenos y poner el background rojo a los que no lo están
		return true;
